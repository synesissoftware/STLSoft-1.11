...
static void test_format_bytes_1_byte_1_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("01", sz, int(n));
}
...
static void test_format_bytes_1_byte_2_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("0001", sz, int(n));
}
...
static void test_format_bytes_1_byte_4_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("00000001", sz, int(n));
}
...
static void test_format_bytes_1_byte_8_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("0000000000000001", sz, int(n));
}
...
static void test_format_bytes_1_byte_16_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("00000000000000000000000000000001", sz, int(n));
}
...
static void test_format_bytes_5_byte_1_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("01 02 03 04 05", sz, int(n));
}
...
static void test_format_bytes_5_byte_2_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("0201 0403 0005", sz, int(n));
}
...
static void test_format_bytes_5_byte_4_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("04030201 00000005", sz, int(n));
}
...
static void test_format_bytes_5_byte_8_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("0000000504030201", sz, int(n));
}
...
static void test_format_bytes_5_byte_16_grouping()
{
    ...
    XTESTS_TEST_MULTIBYTE_STRING_EQUAL_N("00000000000000000000000504030201", sz, int(n));
}
