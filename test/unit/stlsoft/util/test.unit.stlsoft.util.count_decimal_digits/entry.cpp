...
namespace
{
    ...
    static void TEST_count_decimal_digits_WITH_uint16(void);
    static void TEST_count_decimal_digits_WITH_uint32(void);
    static void TEST_count_decimal_digits_WITH_uint64(void);
} // anonymous namespace
